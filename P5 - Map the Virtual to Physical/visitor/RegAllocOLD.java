 ...
 */
public class RegAllocOLD <R,A> implements GJVisitor<R,A> {
   //
  ...
  public void LinearScan (String s){
   ...
   public R visit(Procedure n, A argu) {
      ...
      if(y == 0) x = 8 + Spills.get(n.f0.f0.tokenImage) + z;
      ...
      argoffset = x - Spills.get(n.f0.f0.tokenImage) - z;

      for(i = 0; i < 8; i++){
        System.out.println("\tASTORE SPILLEDARG " + Integer.toString(i) + " s" + Integer.toString(i));
      }
      ...
      for (i=0; i<p; i++) {
        if(i < 4){
          ...
          spil = R.get(s).get(tmp).spillval;
          if(r.equals(";")){
            System.out.print("\tALOAD v1 SPILLEDARG " + Integer.toString(argoffset + i - 4) + "\n");
            System.out.print("\tASTORE SPILLEDARG " + Integer.toString(spil + offset) + " v1\n");
          }
          else{
            System.out.print("\tALOAD " + r + " SPILLEDARG " + Integer.toString(argoffset + i - 4) + "\n");
          }
        }
      }
      ...
      for(i = 0; i < 8; i++){
        System.out.println("\tALOAD " + "s" + Integer.toString(i) + " SPILLEDARG " + Integer.toString(i));
      }
      System.out.println("END");
   ...
   public R visit(HStoreStmt n, A argu) {
      ...
      int tmp1 = Integer.valueOf(n.f1.f1.f0.tokenImage);
      String r1 = new String(R.get(s).get(tmp1).reg);
      int spil1 = R.get(s).get(tmp1).spillval;

      int tmp2 = Integer.valueOf(n.f3.f1.f0.tokenImage);
      String r2 = new String(R.get(s).get(tmp2).reg);
      int spil2 = R.get(s).get(tmp2).spillval;
      
      if(r1.equals(";") && r2.equals(";")){
        System.out.println("\tALOAD v0 SPILLEDARG " + Integer.toString(spil1));
        System.out.println("\tALOAD v1 SPILLEDARG " + Integer.toString(spil2));
        System.out.print("\tHSTORE v0 " + n.f2.f0.tokenImage + " v1\n");
      }
      else if(r1.equals(";")){
        System.out.println("\tALOAD v1 SPILLEDARG " + Integer.toString(spil1));
        System.out.print("\tHSTORE v1 " + n.f2.f0.tokenImage + " " + r2 + "\n");
      }
      else if(r2.equals(";")){
        System.out.println("\tALOAD v1 SPILLEDARG " + Integer.toString(spil2));
        System.out.print("\tHSTORE " + r1 + " " + n.f2.f0.tokenImage + " v1\n");
      }
      else{
        System.out.print("\tHSTORE " + r1 + " " + n.f2.f0.tokenImage + " " + r2 + "\n");
      }
   ...
   public R visit(HLoadStmt n, A argu) {
      ...
      int tmp2 = Integer.valueOf(n.f2.f1.f0.tokenImage);
      String r2 = new String(R.get(s).get(tmp2).reg);
      int spil2 = R.get(s).get(tmp2).spillval;
      
      if(r1.equals(";") && r2.equals(";")){
        System.out.println("\tALOAD v1 SPILLEDARG " + Integer.toString(spil2));
        System.out.print("\tHLOAD v0 v1 " + n.f2.f0.tokenImage + "\n");
        System.out.println("\tASTORE SPILLEDARG " + Integer.toString(spil1) + " v0");
      }
      else if(r1.equals(";")){
        System.out.print("\tHLOAD v1 " + r2 + " " + n.f3.f0.tokenImage + "\n");
        System.out.println("\tASTORE SPILLEDARG " + Integer.toString(spil1) + " v1");
      }
      else if(r2.equals(";")){
        System.out.println("\tALOAD v1 SPILLEDARG " + Integer.toString(spil2));
        System.out.print("\tHLOAD " + r1 + " v1 " + n.f3.f0.tokenImage + "\n");
      }
      else{
        System.out.print("\tHLOAD " + r1 + " " + r2 + " " + n.f3.f0.tokenImage + "\n");
      }
   ...
   public R visit(MoveStmt n, A argu) {
      ...
      if(n.f2.f0.which == 3){
        t = (String) n.f2.accept(this, (A) ":");
        if(!t.equals(";") && !t.equals(":")){
          tmp = Integer.valueOf(t);
          r = new String(R.get(s).get(tmp).reg);
          spil = R.get(s).get(tmp).spillval;
          if(r.equals(";")){
        ...
        n.f2.accept(this, argu);
        if(r.equals(";")){
          System.out.print("\tMOVE v1 v0\n");
          System.out.println("\tASTORE SPILLEDARG " + Integer.toString(spil + offset) + " v1");
        }
        else{
          System.out.print("\tMOVE " + r + " v0\n");
        }
      }
      return _ret;
   }
   ...
   public R visit(PrintStmt n, A argu) {
      ...
      t = (String) n.f1.accept(this, (A) ":");

      if(t.equals(";")){
        System.out.print("\n");
      }
      else if(t.equals(":")){
        // System.out.println(n.f1.f1.tokenImage);
      }
      else{
   ...
   public R visit(Call n, A argu) {
      ...
      int i, cnt = 0;
      for(i = 0; i < 10; i++){
        System.out.println("\tASTORE SPILLEDARG " + Integer.toString(8+i) + " t" + Integer.toString(i));
      }
      ...
      for ( Enumeration<Node> ee = n.f3.elements(); ee.hasMoreElements(); ) {
        ...
        if(cnt < 4){
          tmp = Integer.valueOf(tt);
          r = new String(R.get(s).get(tmp).reg);
          spil = R.get(s).get(tmp).spillval;
          if(r.equals(";")){
            System.out.println("\tALOAD v1 SPILLEDARG " + Integer.toString(spil + offset));
            System.out.print("\tMOVE a" + Integer.toString(cnt) + " v1\n");
          }
          else{
          ...
          if(r.equals(";")){
            System.out.println("\tALOAD v1 SPILLEDARG " + Integer.toString(spil + offset));
            System.out.print("\tASTORE SPILLEDARG " + Integer.toString(argoffset + cnt - 4) + " v1\n");
          }
          else{
      ...
      for(i = 0; i < 10; i++){
        System.out.println("\tALOAD " + "t" + Integer.toString(i) + " SPILLEDARG " + Integer.toString(8+i));
      }
      return _ret;
   }
   ...
   public R visit(BinOp n, A argu) {
      ...
      t = (String) n.f0.accept(this, argu);
